...
public void Modificar(Nodo referencia,Nodo nodoenviar)
{
    boolean b=true;
...
if(nodoAux.getInfoProducto().getClaveProd().equals(referencia.getInfoProducto().getClaveProd()))
{
     ...
     nodoAux.setInfoProducto(nodoenviar.getInfoProducto());
...
if(b==false)
{
     ...
     nodoAux2.setInfoProducto(nodoenviar.getInfoProducto());
...
nodoAux=nodoRaiz;
nodoAux2=nodoAux.getNodoSig();
if(nodoAux.getInfoProducto().getClaveProd().equals(clave))
{
return nodoAux;
}
else
...
while(!nodoAux2.getInfoProducto().getClaveProd().equals(clave)
        &&nodoAux2.getNodoSig()!=null)
        {
        nodoAux=nodoAux2;
        nodoAux2=nodoAux.getNodoSig();
...
if(nodoAux2.getInfoProducto().getClaveProd().equals(clave))
        {
        b=false;
        }
if(b==false)
