		...
		public void actionPerformed(ActionEvent e) {
                    try {
                        ...
                        if(e.getActionCommand().equals("Crear Registro")) {
                            //Aqui llamar a Manejador de Archivo Indexado con lÃ³gica para dar de alta un registro en el archivo
                            //y llenar datos de PanelDatos con mÃ©todos set y get de PanelDatos
           ...
           //////////////////////////////////////////////////////////////////////////
                    ...
                    if (panelDatos.posicionRegistro!=-1)
                        ...
                        System.out.println("No existe ese nombre");
                            ...
                            //Aqui llamar a Manejador de Archivo Indexado con lÃ³gica para borrar un registro en el archivo
                            //y llenar datos de PanelDatos con mÃ©todos set y get de PanelDatos
                            ...
                            //Aqui llamar a Manejador de Archivo Indexado con lÃ³gica para buscar un registro en el archivo
                            //y llenar datos de PanelDatos con mÃ©todos set y get de PanelDatos
                             Nombre=panelDatos.getNombre();
                        for(int i=Nombre.length();i<30;i++)
                             {
